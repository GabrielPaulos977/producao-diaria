...
export default function App() {
  ...
  const tabs = isGestor
    ? [{ k: "home", l: "Painel" }, { k: "gerencial", l: "Gerencial" }, { k: "ranking", l: "Ranking" }, { k: "historico", l: "Histórico" }, { k: "retrabalho", l: "Retrab." }, { k: "preparacao_view", l: "Prepar." }, { k: "inspecoes", l: "Inspeções" }, { k: "import", l: "Importar" }]
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "#0b1121", color: "#d4dce9", fontFamily: "'DM Sans',system-ui,sans-serif", overflowY: "auto", zIndex: 9999 }}>
      ...
      {screen === "gerencial" && (() => {
        ...
        const eqStats = EQUIPES.filter(eq => eq.meta > 0).map(eq => {
        ...
        return (
          <div style={{ padding: "12px 14px 100px" }}>
            ...
            <input type="month" value={histMonth} onChange={e => setHistMonth(e.target.value)} style={{ width: "100%", marginBottom: 14, ...inp }} />
          ...
          <div style={{ padding: "12px 14px 100px" }}>
            ...
            {rM.length > 0 && (
              <details style={{ marginTop: 14 }}>
                <summary style={{ fontSize: 10, color: "#5a7aa0", fontWeight: 700, textTransform: "uppercase", cursor: "pointer", marginBottom: 6 }}>▶ Registros do Mês ({rM.length}) — toque para ver</summary>
