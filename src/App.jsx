          ...
          <div className="resp-content" style={{ padding: "12px 14px 100px" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8, marginBottom: 14 }}>
              ...
              <div style={{ background: "#111d33", borderRadius: 10, padding: "10px 8px", border: "1px solid #1e2d48", textAlign: "center" }}>
                ...
                <div className="m" style={{ fontSize: 20, fontWeight: 800, color: "#34d399" }}>{isFiltered ? (totalInsp > 0 ? Math.round(conformes / totalInsp * 100) : 0) + "%" : eqInsp.filter(e => e.total > 0).length + "/" + EQUIPES.length}</div>
              </div>
            </div>
