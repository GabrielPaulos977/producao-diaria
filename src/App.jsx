...
export default function App() {
  ...
  const tabs = isProgramador
    ...
    : isGestor
    ? [{ k: "home", l: "Painel" }, { k: "gerencial", l: "Gerencial" }, { k: "ranking", l: "Ranking" }, { k: "retrabalho", l: "Retrab." }, { k: "preparacao_view", l: "Prepar." }, { k: "inspecoes", l: "Inspeções" }, { k: "ocorrencias", l: "Ocorrências" }, { k: "programacao_ger", l: "Programação" }, { k: "status", l: "Status" }, { k: "import", l: "Importar" }]
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "#0b1121", color: "#d4dce9", fontFamily: "'DM Sans',system-ui,sans-serif", overflowY: "auto", zIndex: 9999 }}>
      ...
      {/* ═══ OCORRÊNCIAS ═══ */}
      {screen === "ocorrencias" && !ocorrenciaForm && (() => {
