        ...
        <div style={{ textAlign: "center", padding: 30, width: "100%", maxWidth: 340 }}>
          ...
          {!role ? (
            <>
              ...
              <button onClick={() => setRole("gestor")} style={{ width: "100%", padding: "14px 24px", marginBottom: 10, background: "transparent", color: "#60a5fa", border: "2px solid #1e2d48", borderRadius: 12, fontSize: 15, fontWeight: 800, cursor: "pointer" }}>Gerente</button>
              <div style={{ fontSize: 10, color: "#4b6080", marginBottom: 20 }}>Gestão completa, indicadores, ranking</div>
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "#0b1121", color: "#d4dce9", fontFamily: "'DM Sans',system-ui,sans-serif", overflowY: "auto", zIndex: 9999 }}>
      ...
      {screen === "prog_import" && isProgramador && (() => {
        ...
        return (
          <div className="resp-content" style={{ padding: "12px 14px 100px" }}>
      ...
      {screen === "relatorio" && isCoordenador && (() => {
        ...
        return (
          <div className="resp-content" style={{ padding: "0 0 100px", background: "#080e1a" }}>
            {/* Report Header */}
