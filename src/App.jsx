...
export default function App() {
  ...
  const [notaStatusRaw] = useFBData("notaStatus", {});
    ...
    return (
      <div style={{ minHeight: "100vh", background: "#0b1121", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'DM Sans',system-ui,sans-serif" }}>
        ...
        <div style={{ textAlign: "center", padding: 30, width: "100%", maxWidth: 320 }}>
          ...
          <h1 style={{ fontSize: 22, fontWeight: 800, color: "#f8fafc", marginBottom: 4 }}>Indicadores Procel Santa Rosa</h1>
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "#0b1121", color: "#d4dce9", fontFamily: "'DM Sans',system-ui,sans-serif", overflowY: "auto", zIndex: 9999 }}>
      ...
      <div style={{ background: "linear-gradient(135deg,#0f1a2e,#162240)", padding: "10px 16px", borderBottom: "1px solid #1e2d48" }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div>
              <div style={{ fontSize: 13, fontWeight: 800, color: "#f8fafc" }}>Indicadores Procel Santa Rosa</div>
            ...
            <button onClick={() => {
              ...
              retItems.forEach(item => {
                (item.motivos || []).forEach(motivo => {
                  fbPush("retrab", { eqId: retForm.eqId, data: retForm.data, notaId: retForm.notaId, pontoNome: item.pontoNome, qtd: item.qtd, motivo, supervisor: retForm.supervisor || "", obs: retForm.obs || "" });
                });
              });
              setRetForm(null);
      ...
      {screen === "status" && (() => {
        ...
        const setStatus = (notaId, value) => fbSet("notaStatus/" + notaId, value);
      ...
      {screen === "import" && (
        <div style={{ padding: "14px 14px 100px" }}>
          ...
          <button onClick={() => { fbRemove("notas"); fbRemove("atribs"); fbRemove("retrab"); fbRemove("cavas"); fbRemove("preps"); fbRemove("inspecoes"); fbRemove("notaStatus"); setImportMsg("✅ Banco resetado! Reimporte os Excel."); }} style={{ width: "100%", marginTop: 14, padding: "12px 0", background: "rgba(239,68,68,.15)", color: "#ef4444", border: "1px solid rgba(239,68,68,.25)", borderRadius: 10, fontSize: 12, fontWeight: 700, cursor: "pointer" }}>🗑️ Resetar Banco Completo</button>
        </div>
      )}
