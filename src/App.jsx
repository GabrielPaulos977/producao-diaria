...
export default function App() {
  ...
  const tabs = isProgramador
    ...
    : isGestor
    ? [{ k: "home", l: "Painel" }, { k: "gerencial", l: "Gerencial" }, { k: "programacao_ger", l: "Programação" }, { k: "ranking", l: "Ranking" }, { k: "status", l: "Status" }, { k: "seguranca", l: "Segurança" }, { k: "qualidade", l: "Qualidade" }, { k: "retrabalho", l: "Retrab." }, { k: "preparacao_view", l: "Prepar." }, { k: "import", l: "Importar" }]
    : [{ k: "home", l: "Painel" }, { k: "ranking", l: "Ranking" }, { k: "status", l: "Status" }, { k: "retrabalho", l: "Retrab." }, { k: "preparacao_view", l: "Prepar." }, { k: "import", l: "Importar" }];
        ...
        return (
          <div className="resp-content fade-in" style={{ padding: "12px 14px 100px" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
              ...
              <button onClick={() => setAtrasoForm({ nota: "", equipe: "", data: dataSel, motivo: "", descricao: "", diasAtraso: "" })} style={{ padding: "7px 14px", background: "linear-gradient(135deg,#f97316,#ea580c)", color: "#fff", border: "none", borderRadius: 8, fontSize: 11, fontWeight: 800, cursor: "pointer" }}>+ Registrar Atraso</button>
            </div>
