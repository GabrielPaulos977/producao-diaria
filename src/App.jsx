  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "#0b1121", color: "#d4dce9", fontFamily: "'DM Sans',system-ui,sans-serif", overflowY: "auto", zIndex: 9999 }}>
      ...
      {screen === "programacao_ger" && isGestor && (() => {
        ...
        const prs = { "hoje": { l: "Hoje", i: today, f: today }, "esta_semana": { l: "Esta Semana", i: fmt(mon), f: fmt(sun) }, "semana_passada": { l: "Sem. Passada", i: fmt(monL), f: fmt(sunL) }, "este_mes": { l: "Este Mês", i: fmt(mesI), f: fmt(mesF) }, "personalizado": { l: "Personalizado", i: dataSel, f: dataSel } };
