        ...
        return (
          <div className="resp-content fade-in" style={{ padding: "12px 14px 100px" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
              ...
              <button onClick={() => setAtrasoForm({ nota: "", equipe: "", data: dataSel, motivo: "", descricao: "", diasAtraso: "" })} style={{ padding: "7px 14px", background: "linear-gradient(135deg,#f97316,#ea580c)", color: "#fff", border: "none", borderRadius: 8, fontSize: 11, fontWeight: 800, cursor: "pointer" }}>+ Atraso</button>
            </div>
            <div style={{ display: "flex", gap: 0, marginBottom: 12, borderRadius: 10, overflow: "hidden", border: "1px solid #1e2d48" }}>
              ...
              <div key={a._fbKey || i} style={{ background: "#111d33", borderRadius: 10, padding: "10px 12px", marginBottom: 4, border: "1px solid #1e2d48", borderLeft: "3px solid #f97316" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                  <div>
                    ...
                    <div style={{ fontSize: 9, color: "#5a7aa0" }}>{a.equipe} · {a.data?.split("-").reverse().join("/")}{a.diasAtraso ? " · " + a.diasAtraso + " dia(s)" : ""}</div>
                  </div>
          ...
          <div className="resp-content fade-in" style={{ padding: "12px 14px 100px" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              ...
              <div style={{ display: "flex", gap: 8 }}>
                ...
                <div style={{ flex: 1 }}><label style={{ fontSize: 10, color: "#5a7aa0", fontWeight: 700 }}>Dias de atraso</label><input type="number" value={f.diasAtraso} onChange={e => setF("diasAtraso", e.target.value)} placeholder="0" style={{ ...inp, marginTop: 4 }} /></div>
              </div>
